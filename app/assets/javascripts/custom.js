...
var time_block = '<div class="time-block border-blue-400 border-l-2 my-12">' +
    ...
    '</div>' +
    '<div class="pl-4 py-4">' +
    '<textarea id="" placeholder="Task at hand" rows="3" class="task helvetica italic p-2 tracking-wide font-light text-gray-900"></textarea>' +
    '</div>' +
    '<div class="pl-2">' +
...
var time_block_button = '<div class="add-time-block flex ml-8 mt-8">' +
    '<button class="time-block-button bg-gray-400 h-8 relative w-8"></button>' +
