...
$(document).ready(function () {
  ...
  var time_block = '<div class="time-block border-blue-400 border-l-2 my-12">' +
    ...
    '<textarea placeholder="Task at hand" rows="3" class="task-body gothic-neo p-2 tracking-wide text-gray-800" name="timesheet[task_body]" id="timesheet_task_body"></textarea>' +
    "</div>" + '<div class="pl-2">' +
